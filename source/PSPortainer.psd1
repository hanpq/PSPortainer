@{
  ...
  RequiredModules = @()
  FunctionsToExport = @('Connect-Portainer','Disconnect-Portainer','Get-PortainerContainer','Get-PortainerSession','Get-PortainerSettingsPublic','Get-PortainerStatus')
  FileList = @('.\data\appicon.ico','.\data\banner.ps1','.\docs\PSPortainer.md','.\en-US\Connect-Portainer.md','.\en-US\Get-PortainerSettingsPublic.md','.\en-US\Get-PortainerStatus.md','.\en-US\PSPortainer-help.xml','.\include\module.utility.functions.ps1','.\private\.gitignore','.\private\InvokePortainerRestMethod.ps1','.\private\PortainerSession.class.ps1','.\public\Connect-Portainer.ps1','.\public\Disconnect-Portainer.ps1','.\public\Get-PortainerContainer.ps1','.\public\Get-PortainerSession.ps1','.\public\Get-PortainerSettingsPublic.ps1','.\public\Get-PortainerStatus.ps1','.\settings\config.json','.\LICENSE.txt','.\PSPortainer.psd1','.\PSPortainer.psm1')
  PrivateData = @{
